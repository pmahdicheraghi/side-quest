...
const en = {
  ...
  nim: 'Nim',
  nimDescription: 'Three piles of matches. Take any from one row. Grab the last to win.',
  action: '08 / Action',
  tugOfWar: 'Tug of War',
  tugDescription: 'Split-screen tap frenzy. Pull the rope across your line to win.',
  discsUnit: 'discs',
  boxesUnit: 'boxes',
  pairsUnit: 'pairs',
  marksUnit: 'marks',
  ...
  nimPile: 'Pile {pile}',
  takeMatches: 'Take {count} {unit}',
  nimTip: 'Leave piles with balanced binary pairs to force your opponent into a trap.',
  pullRope: 'PULL!',
  tugTip: 'Fast rhythmic tapping wins over frantic random mashing.',
  tugGoalP1: 'Player 1 Goal',
  tugGoalP2: 'Player 2 Goal',
  stats: 'Stats',
...
const fa: Record<TranslationKey, string> = {
  ...
  strategy: '۰۷ / استراتژی',
  nim: 'نیم (چوب‌کبریت)',
  nimDescription: 'چند ردیف چوب‌کبریت؛ در هر نوبت از یک ردیف بردارید. آخرین چوب‌کبریت برنده است!',
  action: '۰۸ / هیجان',
  tugOfWar: 'طناب‌کشی',
  tugDescription: 'نبرد سرعتی و لمس مکرر صفحه! طناب را به سمت مرز خود بکشید و برنده شوید.',
  discsUnit: 'مهره',
  boxesUnit: 'مربع',
  pairsUnit: 'جفت',
  marksUnit: 'علامت',
  ...
  nimPile: 'ردیف {pile}',
  takeMatches: 'برداشتن {count} {unit}',
  nimTip: 'سعی کنید مجموع صفر بسازید تا حریف در هر حرکتی به تله بیفتد.',
  pullRope: 'بکش!',
  tugTip: 'ریتم ضربه‌زدن منظم و سریع، نیروی کشش بیشتری تولید می‌کند.',
  tugGoalP1: 'خط پایان بازیکن ۱',
  tugGoalP2: 'خط پایان بازیکن ۲',
  stats: 'آمار',
