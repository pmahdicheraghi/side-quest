...
const fa: Record<TranslationKey, string> = {
  ...
  sfxDescription: 'صدای حرکات و پیروزی‌ها در بازی',
  haptics: 'لرزش',
  ...
  stats: 'آمار',
  statsTitle: 'آمار و رکوردها',
  statsIntro: 'کارنامه و نتایج شما در تمام بازی‌ها.',
  ...
  fastestReaction: 'بهترین واکنش',
  noStatsYet: 'هنوز مسابقه‌ای ثبت نشده است. یک بازی را تا پایان انجام دهید!',
  resetStats: 'پاک کردن آمار',
  confirmResetStats: 'آیا از بازنشانی تمام آمار اطمینان دارید؟',
  statsResetDone: 'آمار بازی‌ها بازنشانی شد.',
  shareResult: 'اشتراک‌گذاری',
  copiedToClipboard: 'در حافظه کپی شد!',
  shareText: '✦ ساید کوئست — {game}\n{result}\nلینک بازی: {url}',
};
