...
const fa: Record<TranslationKey, string> = {
  ...
  territory: '۰۶ / قلمرو',
  reversi: 'اتلو',
  reversiDescription: 'مهره‌های حریف را محاصره و هم‌رنگ کنید و صفحه را به تسخیر خود درآورید.',
  ...
  reversiScore: 'تعداد مهره‌ها',
  reversiDiscs: '{count} مهره',
  reversiTip: 'خانه‌های گوشه‌ای پایدارترین خانه‌ها هستند و هیچ‌وقت برنمی‌گردند.',
  stats: 'آمار',
